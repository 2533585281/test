...
public class MyBatisPlusGenerator {
    ...
    //数据库连结信息
    private final static String dbUrl = "jdbc:mysql://localhost:3306/test?useUnicode=true&characterEncoding=UTF-8";
    private final static String driver = "com.mysql.jdbc.Driver";
    private final static String userName = "root";
    private final static String password = "root";

    //项目名
    private final static String projectName = "test";
    //指定包名
    private final static String packageName = "com.wzb";
    //controller基础类
    private final static String superControllerClass = packageName + ".common.BaseController";
    //entity基础类
    private final static String superEntityClass = packageName + ".common.BaseEntity";
    //模块名 如果有模块名，则需在模块名前加. 例：.log
    private final static String moduleName = "";
    //作者名
    private final static String author = "WangZhiBo";
    //指定生成的表名
    private final static String[] tableNames = new String[]{"cron"};
...
//        int index = path.indexOf(projectName);
        return "E:/MyDemo/" + projectName + "/src/main/java";
    }
    /**
     * 策略配置
     * @param tableNames 表名
